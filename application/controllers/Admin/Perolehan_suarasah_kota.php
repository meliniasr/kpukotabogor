...
class Perolehan_suarasah_kota extends CI_Controller {

public function __construct()
{
  parent::__construct();
  $this->load->model('m_piechart_kota');
}
  ...
  public function index()
  {
    $data=array(
      ...
      'title2' => 'Data Perolehan Suara Sah Pasangan Calon di Kota Bogor',
...
public function tambah_data(){
    ...
    $this->form_validation->set_rules('tahun', 'Tahun', 'trim|required');
		...
		$this->form_validation->set_rules('rincian_kotabogor_satu', 'Jumlah Rincian di Kota Bogor Paslon 1', 'trim|required');
		$this->form_validation->set_rules('rincian_persen_kotabogor_satu', 'Jumlah Persen Rincian di Kota Bogor Paslon 1', 'trim|required');
		$this->form_validation->set_rules('rincian_kotabogor_dua', 'Jumlah Rincian di Kota Bogor Paslon 2', 'trim|required');
		$this->form_validation->set_rules('rincian_persen_kotabogor_dua', 'Jumlah Persen Rincian di Kota Bogor Paslon 2', 'trim|required');
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      $data = [
          ...
          redirect('admin/perolehan_suarasah_kota');
        }
				  $data=array(
                                  'title' => 'KPU KOTA BOGOR',
                                  'title2' => 'Tambah Data Perolehan Suara Sah Pasangan Calon di Kota Bogor',
                                  'error' => $this->upload->display_errors(),
                                  'jadwal_user' => $this->m_jadwal->jadwal_user(),
                                  'rekapprovinsi_user' => $this->m_rekaphasilsuarasah_provinsi->rekapprovinsi_user(),
                                  'isi' => 'admin/piechartkota/tambah'
                          );
                        $this->load->view('admin/layout/v_wrapper', $data , FALSE);
...
public function hapus($id){
    ...
    $this->m_piechart_kota->delete($data);
...
/* End of file Perolehan_suarasah_kota.php */