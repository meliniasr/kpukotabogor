        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/jadwal_pilpres/edit/'.$jadwal->id_jadwal);
      ?>
              <div class="row">
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="jadwal" id="jadwal" class="form-control" value="<?= $jadwal->jadwal?>"
                      required>
                  </div>
                </div>
                <!-- textarea -->
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <img src="<?= base_url('assets/upload/jadwal/'.$jadwal->foto)?>" width="120px"> &nbsp;
                  </div>
                </div>
              </div>
              <hr>
