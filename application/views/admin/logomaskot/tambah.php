        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/logo_maskot/tambah_data');
      ?>
              <form action="<?= base_url('admin/logo_maskot/tambah_data') ?>" method="POST"
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="desain_suratsuara" id="desain_suratsuara" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_paslon_satu" id="foto_paslon_satu" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_paslon_dua" id="foto_paslon_dua" class="form-control">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="file" name="gambar_maskot" id="gambar_maskot" class="form-control">
                    </div>
                  </div>
                </div>
                <hr>
