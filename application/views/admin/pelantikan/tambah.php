        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/pelantikan/tambah_data');
      ?>
              <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="tgl_pelantikan" id="jadwal_pelantikan" class="form-control"
                      placeholder="Jadwal Pelantikan" data-toggle="datepicker">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_presiden" class="form-control" placeholder="Nama Presiden">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_wapres" class="form-control" placeholder="Nama Wakil Presiden">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="mulai_periode" class="form-control" placeholder="Mulai Periode">
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label>Akhir Periode:</label>
                    <input type="text" name="akhir_periode" class="form-control" placeholder="Akhir Periode">
                  </div>
                </div>
              </div>
              <hr>
