        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/peta_politik/tambah_data');
      ?>
              <div class="row">
                <div class="col-sm-12">
                  <!-- text input -->
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="jml_paslon_satu" id="jml_paslon_satu" class="form-control">
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- text input -->
                  <div class="form-group">
                    ...
                    <input type="text" name="persen_paslon_satu" id="persen_paslon_satu" class="form-control">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="jml_paslon_dua" id="jml_paslon_dua" class="form-control">
                  </div>
                </div>
                <div class="col-sm-6">
                  <!-- text input -->
                  <div class="form-group">
                    ...
                    <input type="text" name="persen_paslon_dua" id="persen_paslon_dua" class="form-control">
                  </div>
                </div>
              </div>
              <div class="row">
