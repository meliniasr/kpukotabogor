          ...
          <div class="card">
            <div class="card-header" style="background-color:#311b1b;color:white">
              ...
              <div class="tombol float-right">
                <a href="<?= base_url('admin/perolehan_suarasah_kota/tambah_data') ?>" class="btn btn-primary btn-sm"><i
                    class="fas fa-plus"></i>
                  Tambah Data</a>&nbsp;
                <a style="color:white" href="#" class="btn btn-info" data-toggle="modal" data-target="#exampleModal"><i
        ...
        <div class="modal-body">
          ...
          <figure class="highcharts-figure">
            ...
            <p class="highcharts-description">
              ...
              <?php foreach($piechartkota_user as $row) {?>
            <ol>
              <li>Hasil jumlah perolehan suara sah pasangan calon 1 yaitu <?=$row->nama_capres_satu?> tahun
                <?=$row->tahun?>
                sebanyak <?= number_format((float)$row->rincian_kotabogor_satu)?> atau sekitar
                <?php
                 $a= $row->rincian_kotabogor_satu;
								 $b= $row->rincian_kotabogor_dua;
                 $hasil = $a / ($a + $b)*100;
									?>
              ...
              <li>Hasil jumlah perolehan suara sah pasangan calon 2 yaitu <?=$row->nama_capres_dua?> tahun
                <?=$row->tahun?>
                sebanyak <?= number_format((float)$row->rincian_kotabogor_dua)?> atau sekitar
                <?php
                 $a= $row->rincian_kotabogor_dua;
								 $b= $row->rincian_kotabogor_satu;
                 $hasil = $a / ($a + $b)*100;
									?>
                <?= number_format((float)$hasil, 1)?>%
              </li>
