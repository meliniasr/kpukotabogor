        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/perolehan_suarasah_provinsi/tambah_data');
      ?>
              <div class="row">
                <div class="col-sm-12">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="rincian_provinsi_satu" id="rincian_provinsi_satu" class="form-control"
                      value="<?= $value->rincian_provinsi_satu?>" readonly>
                    <?php }?>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="rincian_provinsi_dua" id="rincian_provinsi_dua" class="form-control"
                      value="<?= $value->rincian_provinsi_dua?>" readonly>
                    <?php }?>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="rincian_persen_provinsi_satu" id="rincian_persen_provinsi_satu"
                      class="form-control" value="<?= $value->rincian_persen_provinsi_satu?>" readonly>
                    <?php } ?>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="rincian_persen_provinsi_dua" id="rincian_persen_provinsi_dua"
                      class="form-control" value="<?= $value->rincian_persen_provinsi_dua?>" readonly>
                    <?php }?>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group text-center">
                ...
                <button type="reset" class="btn btn-danger">
                  Reset</button>
                <a href="<?= base_url('admin/perolehan_suarasah_provinsi')?>" class="btn btn-warning">
                  Kembali</a>
              </div>
            </div>
          </div>
