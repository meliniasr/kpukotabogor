        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              echo form_open_multipart('admin/rekaphasilsuarasah_kecamatan/tambah_data');
      ?>
              <div class="row">
                <div class="col-sm-12">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <input type="text" name="jumlahakhir_rincian_satu" id="jumlahakhir_rincian_satu"
                      class="form-control" value="0" style="margin-top:-35px;margin-left:250px;" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <input type="text" name="jumlahakhir_rincian_dua" id="jumlahakhir_rincian_dua" class="form-control"
                      value="0" style="margin-top:-35px;margin-left:250px;" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <input type="text" name="jumlahakhir_suarasah" id="jumlahakhir_suarasah" class="form-control"
                      value="0" style="margin-top:-35px;margin-left:180px;" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <input type="text" name="jumlahakhir_suarasah_tdksah" id="jumlahakhir_suarasah_tdksah"
                      class="form-control" value="0" style="margin-top:-35px;margin-left:270px;" readonly>
                  </div>
                </div>
              </div>
              <div class="row">
