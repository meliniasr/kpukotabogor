         ...
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-body">
              ...
              echo form_open_multipart('admin/rekap_partisipasi_pemungutan_suara/edit_datapemilih_dpk/'.$datapemilih_dpk->id_datapemilih_dpk);
      ?>
               <div class="row">
                 <div class="col-sm-12">
                 ...
                 <div class="col-sm-2 ml-3">
                   <div class="form-group">
                     <input type="text" name="dpk_laki_jumlahakhir" id="dpk_laki_jumlahakhir" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_laki_jumlahakhir?>" style="margin-top:-35px;margin-left:200px;"
                       readonly>
                   </div>
                 </div>
               </div>
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorbarat_laki" id="dpk_bogorbarat_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorbarat_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorselatan_laki" id="dpk_bogorselatan_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorselatan_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortengah_laki" id="dpk_bogortengah_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogortengah_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortimur_laki" id="dpk_bogortimur_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogortimur_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorutara_laki" id="dpk_bogorutara_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorutara_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_tanahsareal_laki" id="dpk_tanahsareal_laki" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_tanahsareal_laki?>">
                   </div>
                 </div>
               </div>
               <hr>
                 ...
                 <div class="col-sm-2 ml-4">
                   <div class="form-group">
                     <input type="text" name="dpk_perempuan_jumlahakhir" id="dpk_perempuan_jumlahakhir"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_perempuan_jumlahakhir?>"
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorbarat_perempuan" id="dpk_bogorbarat_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_bogorbarat_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorselatan_perempuan" id="dpk_bogorselatan_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_bogorselatan_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortengah_perempuan" id="dpk_bogortengah_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_bogortengah_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortimur_perempuan" id="dpk_bogortimur_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_bogortimur_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorutara_perempuan" id="dpk_bogorutara_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_bogorutara_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_tanahsareal_perempuan" id="dpk_tanahsareal_perempuan"
                       class="form-control" value="<?=$datapemilih_dpk->dpk_tanahsareal_perempuan?>">
                   </div>
                 </div>
               </div>
               <hr>
               ...
               <div class="row">
                 <div class="col-sm-2 ml-5">
                   <div class="form-group">
                     <input type="text" name="dpk_jumlah_akhir" id="dpk_jumlah_akhir" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_jumlah_akhir?>" style="margin-top:-35px;margin-left:330px;"
                       readonly>
                   </div>
                 </div>
               </div>
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorbarat_jumlah" id="dpk_bogorbarat_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorbarat_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorselatan_jumlah" id="dpk_bogorselatan_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorselatan_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortengah_jumlah" id="dpk_bogortengah_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogortengah_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogortimur_jumlah" id="dpk_bogortimur_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogortimur_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_bogorutara_jumlah" id="dpk_bogorutara_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_bogorutara_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpk_tanahsareal_jumlah" id="dpk_tanahsareal_jumlah" class="form-control"
                       value="<?=$datapemilih_dpk->dpk_tanahsareal_jumlah?>" readonly>
                   </div>
                 </div>
               </div>
               <hr>
