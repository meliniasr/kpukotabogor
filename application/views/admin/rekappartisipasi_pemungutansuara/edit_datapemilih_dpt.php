         ...
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-body">
              ...
              echo form_open_multipart('admin/rekap_partisipasi_pemungutan_suara/edit_datapemilih_dpt/'.$datapemilih_dpt->id_datapemilih_dpt);
      ?>
               <div class="row">
                 <div class="col-sm-12">
                 ...
                 <div class="col-sm-2 ml-3">
                   <div class="form-group">
                     <input type="text" name="dpt_laki_jumlahakhir" id="dpt_laki_jumlahakhir" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_laki_jumlahakhir?>" style="margin-top:-35px;margin-left:200px;"
                       readonly>
                   </div>
                 </div>
               </div>
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorbarat_laki" id="dpt_bogorbarat_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorbarat_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorselatan_laki" id="dpt_bogorselatan_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorselatan_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortengah_laki" id="dpt_bogortengah_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogortengah_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortimur_laki" id="dpt_bogortimur_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogortimur_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorutara_laki" id="dpt_bogorutara_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorutara_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_tanahsareal_laki" id="dpt_tanahsareal_laki" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_tanahsareal_laki?>">
                   </div>
                 </div>
               </div>
               <hr>
                 ...
                 <div class="col-sm-2 ml-4">
                   <div class="form-group">
                     <input type="text" name="dpt_perempuan_jumlahakhir" id="dpt_perempuan_jumlahakhir"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_perempuan_jumlahakhir?>"
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorbarat_perempuan" id="dpt_bogorbarat_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_bogorbarat_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorselatan_perempuan" id="dpt_bogorselatan_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_bogorselatan_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortengah_perempuan" id="dpt_bogortengah_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_bogortengah_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortimur_perempuan" id="dpt_bogortimur_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_bogortimur_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorutara_perempuan" id="dpt_bogorutara_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_bogorutara_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_tanahsareal_perempuan" id="dpt_tanahsareal_perempuan"
                       class="form-control" value="<?=$datapemilih_dpt->dpt_tanahsareal_perempuan?>">
                   </div>
                 </div>
               </div>
               <hr>
                 ...
                 <div class="col-sm-2 ml-5">
                   <div class="form-group">
                     <input type="text" name="dpt_jumlah_akhir" id="dpt_jumlah_akhir" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_jumlah_akhir?>" style="margin-top:-35px;margin-left:330px;"
                       readonly>
                   </div>
                 </div>
               </div>
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorbarat_jumlah" id="dpt_bogorbarat_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorbarat_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorselatan_jumlah" id="dpt_bogorselatan_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorselatan_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortengah_jumlah" id="dpt_bogortengah_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogortengah_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogortimur_jumlah" id="dpt_bogortimur_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogortimur_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_bogorutara_jumlah" id="dpt_bogorutara_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_bogorutara_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="dpt_tanahsareal_jumlah" id="dpt_tanahsareal_jumlah" class="form-control"
                       value="<?=$datapemilih_dpt->dpt_tanahsareal_jumlah?>" readonly>
                   </div>
                 </div>
               </div>
               <hr>
