         ...
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-body">
              ...
              echo form_open_multipart('admin/rekap_partisipasi_pemungutan_suara/edit_hakpilih_dptb/'.$hakpilih_dptb->id_hakpilih_dptb);
      ?>
               <div class="row">
                 <div class="col-sm-12">
                 ...
                 <div class="col-sm-2 ml-2">
                   <div class="form-group">
                     <input type="text" name="hakpilih_dptb_laki_jumlahakhir" id="hakpilih_dptb_laki_jumlahakhir"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_laki_jumlahakhir?>"
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorbarat_laki" id="hakpilih_dptb_bogorbarat_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorbarat_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorselatan_laki" id="hakpilih_dptb_bogorselatan_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorselatan_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortengah_laki" id="hakpilih_dptb_bogortengah_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogortengah_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortimur_laki" id="hakpilih_dptb_bogortimur_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogortimur_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorutara_laki" id="hakpilih_dptb_bogorutara_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorutara_laki?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_tanahsareal_laki" id="hakpilih_dptb_tanahsareal_laki"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_tanahsareal_laki?>">
                   </div>
                 </div>
               </div>
               <hr>
                 ...
                 <div class="col-sm-2 ml-4">
                   <div class="form-group">
                     <input type="text" name="hakpilih_dptb_perempuan_jumlahakhir"
                       id="hakpilih_dptb_perempuan_jumlahakhir" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_perempuan_jumlahakhir?>"
                       style="margin-top:-35px;margin-left:200px;" readonly>
                   </div>
                 </div>
               </div>
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorbarat_perempuan"
                       id="hakpilih_dptb_bogorbarat_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_bogorbarat_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorselatan_perempuan"
                       id="hakpilih_dptb_bogorselatan_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_bogorselatan_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortengah_perempuan"
                       id="hakpilih_dptb_bogortengah_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_bogortengah_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortimur_perempuan"
                       id="hakpilih_dptb_bogortimur_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_bogortimur_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorutara_perempuan"
                       id="hakpilih_dptb_bogorutara_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_bogorutara_perempuan?>">
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_tanahsareal_perempuan"
                       id="hakpilih_dptb_tanahsareal_perempuan" class="form-control"
                       value="<?=$hakpilih_dptb->hakpilih_dptb_tanahsareal_perempuan?>">
                   </div>
                 </div>
               </div>
               <hr>
                 ...
                 <div class="col-sm-2 ml-5">
                   <div class="form-group">
                     <input type="text" name="hakpilih_dptb_jumlah_akhir" id="hakpilih_dptb_jumlah_akhir"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_jumlah_akhir?>"
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorbarat_jumlah" id="hakpilih_dptb_bogorbarat_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorbarat_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorselatan_jumlah" id="hakpilih_dptb_bogorselatan_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorselatan_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortengah_jumlah" id="hakpilih_dptb_bogortengah_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogortengah_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogortimur_jumlah" id="hakpilih_dptb_bogortimur_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogortimur_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_bogorutara_jumlah" id="hakpilih_dptb_bogorutara_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_bogorutara_jumlah?>" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                   <div class="form-group">
                     ...
                     <input type="text" name="hakpilih_dptb_tanahsareal_jumlah" id="hakpilih_dptb_tanahsareal_jumlah"
                       class="form-control" value="<?=$hakpilih_dptb->hakpilih_dptb_tanahsareal_jumlah?>" readonly>
                   </div>
                 </div>
               </div>
               <hr>
