         ...
         <div class="col-md-12">
           <div class="card">
             ...
             <div class="card-body">
              ...
              echo form_open_multipart('admin/rekap_partisipasi_pemungutan_suara/tambah_datapemilih_dptb');
      ?>
               <div class="row">
                 <div class="col-sm-12">
               ...
               <div class="row">
                 <div class="col-sm-2 ml-5">
                   <div class="form-group">
                     <input type="text" name="dptb_jumlah_akhir" id="dptb_jumlah_akhir" class="form-control" value="0"
               ...
               <div class="row">
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     <label>Kecamatan Bogor Tengah:</label>
                     <input type="text" name="dptb_bogortengah_jumlah" id="dptb_bogortengah_jumlah" class="form-control"
                       value="0" readonly>
                   </div>
                 </div>
                 <div class="col-sm-2">
                 ...
                 <div class="col-sm-2">
                   <div class="form-group">
                     <label>Kecamatan Tanah Sareal:</label>
                     <input type="text" name="dptb_tanahsareal_jumlah" id="dptb_tanahsareal_jumlah" class="form-control"
                       value="0" readonly>
                   </div>
                 </div>
               </div>
