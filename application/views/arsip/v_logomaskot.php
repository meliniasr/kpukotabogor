         ...
         <div class="card">
           ...
           <div class="card-body text-center">
             <h2 style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
               PEMILIHAN UMUM PRESIDEN DAN WAKIL PRESIDEN <?= $detail->tahun?></h2>
             <br>
             <img src="<?php echo base_url()?>/assets/upload/istanapresiden.jfif" alt="" width="500">
             <div class="presiden">
               <img width="250px" src="<?php echo base_url().'assets/upload/logomaskot/'.$detail->foto_paslon_satu ?>"
                 style="left: 300px;top:190px;position:absolute" alt="">
               <img width="200px" src="<?php echo base_url().'assets/upload/logomaskot/'.$detail->foto_paslon_dua ?>"
                 style="left: 600px;top:200px;position:absolute" alt="">
               <br><br><br><br>
             ...
             <div class="gambar-maskot"> <img width="100px"
                 src="<?php echo base_url().'assets/upload/logomaskot/'.$detail->gambar_maskot ?>" alt=""
                 style="left: 210px;top:200px;position:absolute"></div>
             <div class="gambar-logo"> <img width="80px"
                 src="<?php echo base_url().'assets/upload/logomaskot/'.$detail->gambar_logo ?>" alt=""
                 style="left:810px;top: 200px;position:absolute"></div>
           </div>
