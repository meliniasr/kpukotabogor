        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            <h4 style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
              PRESIDEN DAN WAKIL PRESIDEN REPUBLIK INDONESIA PERIODE TAHUN
              <?php foreach($pelantikan as $detail) { ?>
              <?=$detail->mulai_periode?>-<?=$detail->akhir_periode?>
            </h4>
            <br>
            <img width="20%" src="<?php echo base_url().'assets/upload/pelantikan/'.$detail->foto_presiden ?>" alt="">
            &nbsp;&nbsp;
            <img width="20%" src="<?php echo base_url().'assets/upload/pelantikan/'.$detail->foto_wapres ?>" alt="">
            <br><br>
            <p
              style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;color:black;margin-left:-228px">
              <?=$detail->nama_presiden?>
            </p>
            <p
              style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;color:black;margin-left:242px;margin-top:-42px">
              <?=$detail->nama_wapres?>
            </p>
            <p style="margin-left:-228px;color:black;"><i>Presiden Republik Indonesia</i></p>
            <p style="margin-left:245px;margin-top:-40px; color:black;"><i>Wakil Presiden Republik Indonesia</i></p>
            <p style="color:black">Pelantikan Presiden dan Wakil Presiden Republik Indonesia
              Periode Masa Jabatan <?=$detail->mulai_periode?>-<?=$detail->akhir_periode?> dilaksanakan pada <br>
              tanggal
              <?=$detail->tgl_pelantikan?> pada Sidang Paripurna Istimewa Majelis Permusyawaratan Rakyat.
            </p>
            <?php } ?>
          </div>
        </div>
