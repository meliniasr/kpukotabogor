        ...
        <div class="card">
          ...
          <div class="card-body text-center">
            <h4 style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">
              ...
              PRESIDEN TAHUN <?= $detail->tahun?> DI KOTA BOGOR, PROVINSI JAWA BARAT DAN NASIONAL
            </h4>
            <br>
            <table id="example1" class="table table-bordered table-striped" style="color:black">
              ...
              <thead>
                ...
                <tr>
                  <td colspan="3" style="font-weight:bold;text-align:left">Jumlah Suara Sah dan Tidak Sah Seluruh
                    Pasangan Calon</td>
                ...
                <tr>
                  <td colspan="3" style="font-weight:bold;text-align:left">Jumlah Pemilih Terdafar Pada Hari Pemungutan
                    Suara</td>
                  <td><?= number_format((float)$detail->hakpemilih_kotabogor)?></td>
                  <td></td>
                  <td><?= number_format((float)$detail->hakpemilih_provinsi)?></td>
                  <td></td>
                  <td><?= number_format((float)$detail->hakpemilih_nasional)?></td>
                  <td></td>
                </tr>
                <tr>
                  <td colspan="3" style="font-weight:bold;text-align:left">Pemilih Yang Tidak Menggunakan Hak Pilih</td>
